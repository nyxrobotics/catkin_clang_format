...
if(_CATKIN_FORMAT_EXTRAS_INCLUDED_)
  return()
endif()
set(_CATKIN_FORMAT_EXTRAS_INCLUDED_ TRUE)

include(CMakeParseArguments)

@[if DEVELSPACE]@
# cmake dir in develspace
set(CATKIN_FORMAT_CMAKE_DIR "@(CMAKE_CURRENT_SOURCE_DIR)/cmake")
@[else]@
# cmake dir in installspace
set(CATKIN_FORMAT_CMAKE_DIR "@(PKG_CMAKE_DIR)")
@[end if]@
