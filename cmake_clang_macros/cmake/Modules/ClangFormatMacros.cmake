...
macro(enable_clang_build)
  ...
  file(GLOB_RECURSE MY_HEADERS_H "include/*.h" "src/*.h")
  file(GLOB_RECURSE MY_HEADERS_HPP "include/*.hpp" "src/*.hpp")
  file(GLOB_RECURSE MY_HEADERS_HH "include/*.hh" "src/*.hh")
  set(MY_HEADERS ${MY_HEADERS_H} ${MY_HEADERS_HPP} ${MY_HEADERS_HH})
endmacro()
